...
export default new Vuex.Store({
	...
	state: {
		//页面相关
		pageId: "", //页面ID		9321ab53213f47d595b1947a93f8abb6
		pageName: "", //页面名称
		templateId: "", //来源模板ID 
		themeColor: "409eff", //主题颜色
		fontSize: 16, //字号
		
		editingPage: false, //是否正在编辑页面
	...
	*/
	mutations: {
		...
		//设置当前是否正在编辑页面
		//status: true(正在编辑)  false:未编辑
		setEditingPageState(state, status) {
			state.editingPage = status
		},
		//设置主题颜色
